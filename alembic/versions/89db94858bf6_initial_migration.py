...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_games_category_id"), "games", ["category_id"], unique=False
    )
    op.create_index(op.f("ix_games_id"), "games", ["id"], unique=False)
    op.create_index(
        op.f("ix_games_is_multiplayer"), "games", ["is_multiplayer"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_game_activities_id"), "game_activities", ["id"], unique=False
    )
    op.create_table(
        "upvotes",
        sa.Column("user_id", sa.UUID(), nullable=False),
